...
<header id="page-hero" class="site-header d-flex flex-column align-content-between">
    <nav class="site-nav navbar fixed-top navbar-expand-md navbar-light bg-light justify-content-between shadow-lg">
        ...
        <img src="{{ asset('images/logo.svg') }}" alt="" width="30" height="30" class="d-inline-block align-top">
            أجاويد
        </a>
        ...
        <div class="collapse navbar-collapse bg-light" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a href="{{ route('events.index') }}" class="nav-link">الفعاليات</a></li>
                <li class="nav-item"><a href="{{ route('login') }}" class="nav-link">@lang('Login')</a></li>
                <li class="nav-item"><a href="{{ route('register') }}" class="nav-link">@lang('Register')</a></li>
            </ul>
        </div>
    </nav>
</header>
