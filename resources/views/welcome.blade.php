...
<header id="page-hero" class="site-header d-flex flex-column align-content-between">
    <nav class="site-nav navbar fixed-top navbar-expand-md navbar-light bg-light justify-content-between shadow-lg">
        <a href="#" class="navbar-brand">
        <img src="{{ asset('images/logo.svg') }}" alt="" class="d-inline-block align-top" style="height: 3rem;">
            أجاويد
        </a>
        ...
        <div class="collapse navbar-collapse bg-light" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="#" class="nav-link text-center p-3">الرئيسية</a></li>
                <li class="nav-item"><a href="{{ route('events.index') }}" class="nav-link text-center p-3">الفعاليات</a></li>
                <li class="nav-item mx-2 my-2"><a href="{{ route('login') }}" class="btn btn-secondary btn-lg btn-block">@lang('Login')</a></li>
                <li class="nav-item mx-2 my-2"><a href="{{ route('register') }}" class="btn btn-primary btn-lg btn-block">@lang('Register')</a></li>
            </ul>
        </div>
    </nav>
</header>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="min-height: 300px">
                            ...
                            <div class="row flex justify-content-center align-items-center">
                                <div class="display-4 my-1">{{ $event->count_male }}</div>
                                ...
                                <div class="display-4 my-1">{{ $event->count_female }}</div>
                            </div>
                        </div>
