<!DOCTYPE html>
<html lang="ar" class="h-full font-sans antialiased">
<head>
    <meta charset="utf-8">
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('nova-assets/app-rtl.css') }}">
...
<body class="min-w-site bg-40 text-black min-h-full" dir="rtl">
    <div id="nova">
