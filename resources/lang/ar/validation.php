...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'mobile'         => [
            'regex' => 'يجب أن يتكون الجوال من عشرة أرقام ويبدأ بـ05',
        ],
        'birth_date'     => [
            'before' => 'العمر الأدنى المسموح به للتسجيل هو 13 عامًا.',
        ],
        'avatar'         => [
            'dimensions' => 'يجب أن لا يقل طول وعرض الصورة عن 300 بيكسل.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'مُتاح',
        'size'                  => 'الحجم',
        'official_id'           => 'الهوية الوطنية أو الإقامة',
